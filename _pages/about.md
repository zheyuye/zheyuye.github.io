...
**2025.** One paper received **ACL 2025 Outstanding Paper Award** (Towards the Law of Capacity Gap in Distilling Language Models).

**2025.** One paper accepted to **ACL 2025 Demo** (iPET: An Interactive Emotional Companion Dialogue System).

**2025.** One paper accepted to **SIGIR 2025 Industry Track** (PaRT: Enhancing Proactive Social Chatbots with Personalized Real-Time Retrieval).

**2024.** AI Agent创新应用项目获**小红书2024年度最佳项目（用户突破）**。

**2024.** One dataset paper accepted to **EMNLP 2025 Dataset Track** (RedOne: Revealing Domain-specific LLM Post-Training in Social Networking Services).
